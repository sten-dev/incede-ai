        ...
        <Container>
          ...
          <Row>
            <Col>
              <h4 className="text-uppercase">
                <b className="color-grey">Watson Discovery Design Services</b>
              </h4>
              <div className="content">
                <p>
                  ...
                  it. Incede develops a phased Enterprise Search and AI Search
                ...
                <p>
                  ...
                  enterprise search and AI search solution. We confirm the data
                  sources, prioritize the annotation and enrichment methods and
                  plan the integrations to ensure a positive user experience
                  with relevant, trusted answers.
                </p>
              </div>
            </Col>
            <Col
            ...
            <Col xs={12}>
              <div className="content-outcomes">
                ...
                <ul>
                  <li>
                    <p>
                      Standardized inventory of document collections and content
                      areas to surface new insights in targeted workflows.
                    </p>
                  </li>
                  <li>
                    <p>
                      Unified design of natural language question and answer
                      across channel, chat and the knowledge base.
                    </p>
                  </li>
                  <li>
                    <p>
                      Iterative approach to deliver insights and business value
                      quickly.
                    </p>
                  </li>
                </ul>
          ...
          <Row>
            <Col xs={12}>
              ...
              <div className="content">
                <p>
                  Brings in the structured and unstructured data from internal,
                  external and/or public sources such as Box, salesforce,
                  Microsoft Sharepoint, web crawl and the IBM Cloud Object
                  Storage. Unstructured data within documents such as pdf, MS
                  Word, MS PowerPoint, MS Excel, HTML and even scanned images
                  are included.
                </p>
              </div>
            </Col>
            <Col xs={12}>
              <h4 className="mb-0">
                <b className="color-grey">Enrichment Development Services</b>
              </h4>
              <div className="content">
                <p>
                  Applies the understanding of what data is being brought into
                  the enterprise search and search AI solution. Enrichments or
                  meta data development includes entity and category
                  identification, semantics and parts of speech parsing,
                  sentimental analysis, emotion identification, keywords, and
                  concept tagging.
                </p>
              </div>
            </Col>
            <Col xs={12}>
              ...
              <div className="content">
                <p>
                  Applies custom or specialized natural language enrichments
                  using IBM Watson Knowledge Studio to identify entities and
                  relationships unique to your business or organization.
                  Advanced enrichment is used for complex content such as images
                  and tables to improve the relevancy of answers.
                </p>
              </div>
            </Col>
            <Col xs={12}>
              ...
              <div className="content">
                <p>
                  It is the process of teaching the solution, using Smart
                  Document Understand (SDU), how to understand the structure of
                  the documents and collections of documents. Relevancy is
                  assessed and improved through training to ensure the system is
            ...
            <Col xs={12}>
              ...
              <div className="content">
                <p>
                  ...
                  relevancy before and after applying relevancy training.
                </p>
              </div>
            </Col>
          </Row>
