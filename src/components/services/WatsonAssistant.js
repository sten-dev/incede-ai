        ...
        <Container>
          ...
          <Row>
            <Col>
              <h4 className="text-uppercase">
                <b className="color-grey">Watson Assistant Design Services</b>
              </h4>
              ...
              <div className="content">
                <p>
                  ...
                  you intend.Incede develops a phased Conversational AI Design
                  for a solution that meets your UX, technology and strategic
                ...
                <p>
                  ...
                  or invoking a transaction. We plan for how to train and
                  maintain the conversational AI model and when to incorporate
            ...
            <Col xs={12}>
              <div className="content-outcomes">
                ...
                <ul>
                  <li>
                    <p>
                      Phased approach that delivers incremental business value
                      quickly.
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p>
                      Detailed plan of the resources needed to design, develop,
                      train and monitor the AI solution.
                    </p>
                  </li>
                </ul>
              </div>
            ...
            <Col>
              ...
              <div className="content-outcomes">
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      Optimized relevancy training to improves user’s trust in
                      answers.
                    </p>
                  </li>
                  <li>
          ...
          <Row>
            <Col xs={12}>
              ...
              <div className="content">
                <p>
                  It accommodates user interactions via text and voice and
                  integrates capabilities such as translations and channels.
                </p>
              </div>
            </Col>
            <Col xs={12}>
              <h4 className="mb-0">
                <b className="color-grey">Context Development Services</b>
              </h4>
              <div className="content">
                <p>
                  These are the implementation of the solution’s ability to
                  successfully match user inquiries with planned intents. For
                  those intents, develop the supporting conversational dialogs
                  of responses, triggers and decision trees
                </p>
              </div>
            </Col>
            <Col xs={12}>
              <h4 className="mb-0">
                <b className="color-grey">Integration Development Services</b>
              </h4>
              <div className="content">
                <p>
                  They expand available context through back-end systems for
                  security, data or enterprise AI search of knowledge bases
            ...
            <Col xs={12}>
              <h4 className="mb-0">
                <b className="color-grey">Channel Development Services</b>
              </h4>
              <div className="content">
                <p>
                  Integrate multi-channel deployments on mobile and web with
                  integrations to Facebook, Slack, Alexa, Google Assistant,
                  Siri, WhatsApp and third-party enterprise chatbot solutions.
                </p>
              </div>
            </Col>
            <Col xs={12}>
              <h4 className="mb-0">
                <b className="color-grey">Exception Handling Services</b>
              </h4>
              <div className="content">
                <p>
                  Identifies and models outliners and escalations to ensure the
                  routing of requests that are not understood or poorly
                  understood.
                </p>
              </div>
            </Col>
            <Col xs={12}>
              ...
              <div className="content">
                <p>
                  Applies initial and re-training of the solution to parse,
                  identify languages and various categories such as intents,
                  actions, entities and the context around which responses will
                  be framed and improved.
                </p>
              </div>
            </Col>
            <Col xs={12}>
              ...
              <div className="content">
                <p>
                  Deploy solutions on either cloud or on-premise and utilize
                  microservices and REST-based architectures for minimal
                  downtime.
                </p>
              </div>
            </Col>
            <Col xs={12}>
              <h4 className="mb-0">
                <b className="color-grey">Post-Production Support Services</b>
              </h4>
              <div className="content">
                <p>
                  These are ongoing support and monitoring for live services,
                  including ongoing optimization of the solution.
                </p>
              </div>
            </Col>
          </Row>
